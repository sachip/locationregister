...
public class LocationClientController {
	...
	public String readLocation(@RequestParam("protocol")  String protocol, @RequestParam("location") String location, Model model, HttpServletRequest request) throws LocationNotFoundException {
